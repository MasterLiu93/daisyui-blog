...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // 移除重复的路由变化监听，因为App.tsx中已经有ScrollToTop组件
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* 导航栏 */}
      <header className="sticky top-0 z-30 bg-base-100/80 backdrop-blur-md shadow-sm">
        <div className="navbar container mx-auto px-4">
          <div className="navbar-start">
            <Link to="/" className="text-xl font-bold text-base-content">
              <span className="text-primary">Laby</span>Blog
            </Link>
          </div>
          ...
          {/* 移动端菜单 */}
          <div className="navbar-center lg:hidden flex-1">
              <div className="dropdown">
                ...
                <ul 
                  tabIndex={0} 
                  className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 ${menuOpen ? 'block' : 'hidden'}`}
