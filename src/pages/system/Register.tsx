...
const Register = () => {
  const { t, i18n } = useTranslation(['system/register', 'common']);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-base-300 via-base-200 to-base-300 relative overflow-hidden">
      ...
      <div className="fixed top-4 right-4 flex gap-2 z-10">
        ...
        <div className="dropdown dropdown-end">
          <div tabIndex={0} role="button" className="btn btn-sm btn-ghost text-base-content bg-base-100/70 backdrop-blur-md hover:bg-base-100/90 transition-all duration-300 shadow-md hover:shadow-lg">
            ...
            <span className="ml-1 text-adaptive">{t('chooseTheme', { ns: 'common' })}</span>
          </div>
          <div tabIndex={0} className="dropdown-content p-4 shadow-lg bg-base-100 rounded-box w-80 z-[20] max-h-96 overflow-y-auto">
            <h3 className="text-center font-bold mb-3 pb-2 border-b border-base-300">{t('chooseTheme', { ns: 'common' })}</h3>
      ...
      <div className="fixed top-4 left-4 z-10">
        <Link to="/system/login" className="btn btn-sm btn-ghost text-base-content bg-base-100/70 backdrop-blur-md hover:bg-base-100/90 transition-all duration-300 shadow-md hover:shadow-lg">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
          </svg>
          <span className="ml-1 hidden md:inline">{t('backToLogin', { defaultValue: 'Back to Login' })}</span>
        </Link>
      </div>
      ...
      <div className="container mx-auto px-4 z-5 relative">
        <div className="flex flex-col md:flex-row max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-2xl">
          {/* 左侧图片区域 */}
          <motion.div 
            className="w-full md:w-1/2 bg-gradient-to-br from-secondary to-primary p-12 text-primary-content flex flex-col justify-center items-center hidden md:flex"
      ...
      <motion.div
          ...
          {error && (
            ...
            <div className="form-control">
              ...
              <label className="label">
                    <span className="label-text-alt text-base-content/70">{t('errors.passwordFormat')}</span>
              </label>
            </div>
              ...
              <label className="label cursor-pointer justify-start gap-2">
                <input 
                  ...
                  disabled={loading}
                />
                    <span className="label-text">{t('agreement')}</span>
              </label>
            </div>
            ...
            <div className="form-control mt-6">
              ...
              <div className="divider my-6">{t('or', { ns: 'common' })}</div>
          
          <div className="text-center">
            <p className="text-base-content/70">
                  {t('haveAccount')} 
              <Link to="/system/login" className="link link-primary ml-1">
                    {t('login')}
              </Link>
            </p>
