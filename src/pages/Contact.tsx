...
const contactMethods = [
  {
    ...
    value: "contact@laby.dev",
      action: t('contact.form.sendEmail'),
  ...
  },
  {
    ...
    value: "@laby_dev",
      action: t('contact.form.followMe'),
      url: "https://twitter.com/laby_dev",
      color: "secondary",
      bg: "bg-secondary/10"
  },
  {
    ...
    value: "+86 123 4567 8901",
      action: t('contact.form.scheduleCall'),
...
const faqs = [
  {
      question: t('contact.faq.questions.0.q'),
      answer: t('contact.faq.questions.0.a')
  },
  {
      question: t('contact.faq.questions.1.q'),
      answer: t('contact.faq.questions.1.a')
  },
  {
      question: t('contact.faq.questions.2.q'),
      answer: t('contact.faq.questions.2.a')
  },
  {
      question: t('contact.faq.questions.3.q'),
      answer: t('contact.faq.questions.3.a')
  },
  {
      question: t('contact.faq.questions.4.q'),
      answer: t('contact.faq.questions.4.a')
  }
];
              ...
              <div className="card-body relative z-10">
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <p className="text-lg">{t('contact.form.success.message')}</p>
                  </motion.div>
                ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="form-control">
                ...
                >
                        ...
                        <option value="job">{t('contact.form.subjectOptions.job')}</option>
          ...
          >
              ...
              {/* 这里可以替换为实际的地图组件 */}
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 bg-base-100/70 backdrop-blur-sm">
                      <h3 className="text-xl font-bold">{t('contact.location.office')}</h3>
              ...
              <div className="card bg-gradient-to-br from-accent/10 to-secondary/10 shadow-xl border border-base-200 overflow-hidden">
                <div className="card-body">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <div className="badge badge-outline">{t('contact.remote.badges.meetings')}</div>
                    <div className="badge badge-outline">{t('contact.remote.badges.flexible')}</div>
                    <div className="badge badge-outline">{t('contact.remote.badges.global')}</div>
                    <div className="badge badge-outline">{t('contact.remote.badges.realtime')}</div>
              </div>
            </div>
            </div>
          </motion.div>
      ...
      {/* FAQ部分 */}
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto">{t('contact.faq.description')}</p>
          </div>
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-6 lg:mb-0">
                  ...
                  <p>{t('contact.subscribe.description')}</p>
            </div>
            <div className="lg:w-1/2">
              <div className="flex flex-col sm:flex-row gap-2">
                    <input type="email" placeholder={t('contact.subscribe.placeholder')} className="input input-bordered flex-grow shadow-inner" />
                    <motion.button 
