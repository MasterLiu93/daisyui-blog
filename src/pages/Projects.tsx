...
const Projects = () => {
  ...
  const projects = useMemo(() => [
  {
    id: 1,
      ...
      longDescription: t('projects.items.project1.longDescription'),
  ...
  },
  {
    id: 2,
      ...
      longDescription: t('projects.items.project2.longDescription'),
  ...
  },
  {
    id: 3,
      ...
      longDescription: t('projects.items.project3.longDescription'),
  ...
  },
  {
    id: 4,
      ...
      longDescription: t('projects.items.project4.longDescription'),
  ...
  },
  {
    id: 5,
      ...
      longDescription: t('projects.items.project5.longDescription'),
  ...
  },
  {
    id: 6,
      ...
      longDescription: t('projects.items.project6.longDescription'),
  ...
  const categories = useMemo(() => [
    { id: "all", name: t('projects.filter.all'), icon: "🌟" },
    { id: "web", name: t('projects.filter.web'), icon: "🌐" },
    { id: "mobile", name: t('projects.filter.mobile'), icon: "📱" },
    { id: "ai", name: t('projects.filter.ai'), icon: "🧠" },
    { id: "blockchain", name: t('projects.filter.blockchain'), icon: "⛓️" },
    { id: "iot", name: t('projects.filter.iot'), icon: "📡" }
  ], [t]);
          ...
          {filteredProjects.length > 0 ? (
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-adaptive">{t('projects.notFound.title')}</h3>
                <p className="text-adaptive-muted mb-4">{t('projects.notFound.description')}</p>
            <button 
        ...
        <div className="relative card bg-gradient-to-br from-base-200/70 to-base-100/70 backdrop-blur-sm shadow-xl border border-base-content/10 max-w-3xl mx-auto overflow-hidden">
          ...
          <div className="card-body text-center relative z-10">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              {t('projects.cooperation.description')}
            </motion.p>
            ...
            >
              ...
              >
                <a href="https://github.com/your-username" target="_blank" rel="noopener noreferrer" className="btn btn-outline shadow-md">
                  ...
                  {t('projects.cooperation.githubCta')}
                </a>
              </motion.div>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="py-6">
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-bold mb-2 text-adaptive">{t('projects.techstack')}</h3>
