    ...
    >
      ...
      <div className={`card-body relative z-10 ${featured ? 'md:w-3/5' : ''}`}>
        {post.featured && !featured && (
          <div className="badge badge-secondary mb-2">{t('blog.blog.featured')}</div>
        )}
        ...
        <div className="flex justify-between items-center text-sm mt-3 text-adaptive-muted">
          <div className="flex items-center gap-2">
            <span className="flex items-center">
              ...
              {post.readTime} {t('blog.blog.readTime')}
            </span>
            <span className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Blog = () => {
  ...
  {
    id: 1,
      title: t('blog.blog.posts.post1.title'),
      subtitle: t('blog.blog.posts.post1.subtitle'),
      excerpt: t('blog.blog.posts.post1.excerpt'),
      content: t('blog.blog.posts.post1.content'),
  ...
  {
    id: 2,
      title: t('blog.blog.posts.post2.title'),
      subtitle: t('blog.blog.posts.post2.subtitle'),
      excerpt: t('blog.blog.posts.post2.excerpt'),
      content: t('blog.blog.posts.post2.content'),
  ...
  {
    id: 3,
      title: t('blog.blog.posts.post3.title'),
      subtitle: t('blog.blog.posts.post3.subtitle'),
      excerpt: t('blog.blog.posts.post3.excerpt'),
      content: t('blog.blog.posts.post3.content'),
      author: "Maria Garcia",
      date: "2024-01-15",
  ...
  {
    id: 4,
      title: t('blog.blog.posts.post4.title'),
      subtitle: t('blog.blog.posts.post4.subtitle'),
      excerpt: t('blog.blog.posts.post4.excerpt'),
      content: t('blog.blog.posts.post4.content'),
      author: "David Wang",
      date: "2024-02-02",
  ...
  {
    id: 5,
      title: t('blog.blog.posts.post5.title'),
      subtitle: t('blog.blog.posts.post5.subtitle'),
      excerpt: t('blog.blog.posts.post5.excerpt'),
      content: t('blog.blog.posts.post5.content'),
      author: "James Wilson",
      date: "2024-01-18",
  ...
  {
    id: 6,
      title: t('blog.blog.posts.post6.title'),
      subtitle: t('blog.blog.posts.post6.subtitle'),
      excerpt: t('blog.blog.posts.post6.excerpt'),
      content: t('blog.blog.posts.post6.content'),
      author: "Emily Chen",
      date: "2024-02-12",
  ...
  {
    id: 7,
      title: t('blog.blog.posts.post7.title'),
      subtitle: t('blog.blog.posts.post7.subtitle'),
      excerpt: t('blog.blog.posts.post7.excerpt'),
      content: t('blog.blog.posts.post7.content'),
      author: "Thomas Brown",
      date: "2023-12-18",
  ...
  {
    id: 8,
      title: t('blog.blog.posts.post8.title'),
      subtitle: t('blog.blog.posts.post8.subtitle'),
      excerpt: t('blog.blog.posts.post8.excerpt'),
      content: t('blog.blog.posts.post8.content'),
  ...
  {
    id: 9,
      title: t('blog.blog.posts.post9.title'),
      subtitle: t('blog.blog.posts.post9.subtitle'),
      excerpt: t('blog.blog.posts.post9.excerpt'),
      content: t('blog.blog.posts.post9.content'),
      author: "Michael Lee",
      date: "2024-02-08",
...
const categories = [
  { id: 'all', name: 'All' },
  { id: 'frontend', name: t('blog.blog.categories.frontend') },
  { id: 'backend', name: t('blog.blog.categories.backend') },
  { id: 'design', name: t('blog.blog.categories.design') },
  { id: 'ai', name: t('blog.blog.categories.ai') },
  { id: 'security', name: t('blog.blog.categories.security') }
];
            ...
            {categories.map(category => (
              ...
              >
                ...
                <div className="relative flex-grow max-w-xs">
                  <input
                    type="text"
                    placeholder={t('blog.blog.searchPlaceholder')}
          ...
          <div className="space-y-8">
              ...
              <div className="card-body">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-adaptive-muted">{t('blog.blog.about.description')}</p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="card-body relative z-10">
                ...
                >
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
                  {t('blog.blog.subscribeTitle')}
                  </span>
                  <div className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-secondary to-primary"></div>
                </motion.h3>
                
                <p className="text-sm text-adaptive-muted mb-4">
                  {t('blog.blog.subscribeDescription')}
                </p>
