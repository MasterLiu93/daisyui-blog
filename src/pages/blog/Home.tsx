...
import TestimonialsCarousel from "../../components/blog/TestimonialsCarousel";
import SkillsShowcase from "../../components/blog/SkillsShowcase";
import CounterSection from "../../components/blog/CounterSection";
import TechStackGlobe from "../../components/blog/TechStackGlobe";
...
const Home = () => {
  ...
  {
    id: 1,
      title: t('blog.home.projects.items.project1.title', '智能家居控制系统'),
      description: t('blog.home.projects.items.project1.description', '基于React和Node.js的智能家居控制平台'),
  ...
  {
    id: 2,
      title: t('blog.home.projects.items.project2.title', '电子商务平台'),
      description: t('blog.home.projects.items.project2.description', '基于Next.js和Stripe的现代电子商务平台'),
  ...
  {
    id: 3,
      title: t('blog.home.projects.items.project3.title', '健康追踪应用'),
      description: t('blog.home.projects.items.project3.description', 'React Native构建的健康追踪应用'),
  ...
  const blogPosts = [
    {
      id: 1,
      title: t('blog.home.blog.posts.post1.title', 'React中的状态管理最佳实践'),
      excerpt: t('blog.home.blog.posts.post1.excerpt', '探索不同的状态管理解决方案，从Context API到Redux和Zustand'),
    ...
    {
      id: 2,
      title: t('blog.home.blog.posts.post2.title', 'TypeScript高级类型和模式'),
      excerpt: t('blog.home.blog.posts.post2.excerpt', '深入TypeScript的类型系统，掌握高级类型和设计模式'),
    ...
    {
      id: 3,
      title: t('blog.home.blog.posts.post3.title', 'CSS布局技术的演变'),
      excerpt: t('blog.home.blog.posts.post3.excerpt', '从表格到Flexbox和Grid，CSS布局技术的发展历程'),
  ...
  const counterItems = [
    {
      value: 5,
      label: t('blog.home.counter.yearsExperience'),
      suffix: "+",
      color: "hsl(var(--p))",
      icon: (
    ...
    {
      value: 50,
      label: t('blog.home.counter.projectsCompleted'),
      suffix: "+",
      color: "hsl(var(--s))",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      value: 99,
      label: t('blog.home.counter.satisfactionRate'),
      suffix: "%",
      color: "hsl(var(--a))",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      value: 20,
      label: t('blog.home.counter.clientsServed'),
      suffix: "+",
      color: "hsl(var(--p))",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  const testimonialItems = [
    {
      id: 1,
      name: t('blog.home.testimonials.people.zhang'),
      role: t('blog.home.testimonials.roles.ceo'),
      company: t('blog.home.testimonials.companies.tech'),
      content: t('blog.home.testimonials.items.testimonial1'),
      rating: 5,
      image: "/images/user/header.jpg"
    },
    {
      id: 2,
      name: t('blog.home.testimonials.people.wang'),
      role: t('blog.home.testimonials.roles.productManager'),
      company: t('blog.home.testimonials.companies.digital'),
      content: t('blog.home.testimonials.items.testimonial2'),
      rating: 5,
      image: "/images/user/header.jpg"
    },
    {
      id: 3,
      name: t('blog.home.testimonials.people.li'),
      role: t('blog.home.testimonials.roles.cto'),
      company: t('blog.home.testimonials.companies.smart'),
      content: t('blog.home.testimonials.items.testimonial3'),
      rating: 5,
      image: "/images/user/header.jpg"
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      <Hero
        title={t('blog.home.hero.title')}
        subtitle={t('blog.home.hero.description')}
        badge={t('blog.home.hero.badge')}
        backgroundStyle="3d"
        height="full"
        scrollY={scrollY}
        buttons={[
          {
            label: t('blog.home.hero.cta'),
            to: "/projects",
            variant: "primary",
            icon: (
          ...
          {
            label: t('blog.home.hero.contactCta'),
            to: "/contact",
            variant: "outline",
            icon: (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              ...
              {t('blog.home.projects.subtitle', '我们的作品集')}
              </span>
            ...
            <p className="text-adaptive-muted max-w-2xl mx-auto">
              {t('blog.home.projects.description', 'Browse our selected projects showcasing our expertise and creativity across various domains')}
            </p>
          </div>
          ...
          <div className="mt-12 flex justify-center">
            ...
            >
              {t('blog.home.projects.viewAllButton')}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </Link>
      ...
      <section className="py-20 relative overflow-hidden bg-base-100">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
              {t('blog.home.techStack.title', '技术栈')}
              </span>
              <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-secondary to-primary"></div>
            </h2>
            <p className="text-adaptive-muted max-w-2xl mx-auto">
              {t('blog.home.techStack.description', 'I use modern technology stacks to build powerful and scalable applications')}
            </p>
          </div>
      ...
      <section className="py-20 bg-base-100 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
              {t('blog.home.stats.title', '成就与数据')}
              </span>
              <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-secondary to-primary"></div>
            </h2>
            <p className="text-adaptive-muted max-w-2xl mx-auto">
              {t('blog.home.stats.description', 'Rich experience and project outcomes from years of professional development')}
            </p>
          </div>
      ...
      <section className="py-20 bg-base-200 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
              {t('blog.home.skills.title', '专业技能')}
              </span>
              <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-secondary to-primary"></div>
            </h2>
            <p className="text-adaptive-muted max-w-2xl mx-auto">
              {t('blog.home.skills.description', 'I master various frontend and backend technologies to build high-quality full-stack applications')}
            </p>
          </div>
      ...
      <section className="py-20 bg-base-100 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
                {t('blog.home.blog.title', '最新资讯')}
              </span>
              <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-secondary to-primary"></div>
            </h2>
            <p className="text-adaptive-muted max-w-2xl mx-auto">
              {t('blog.home.blog.description', 'Stay updated with industry trends, technology insights, and our professional perspectives')}
            </p>
          </div>
          ...
          <div className="mt-12 flex justify-center">
            ...
            >
              {t('blog.home.blog.viewAllButton')}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </Link>
      ...
      <section className="py-20 bg-base-200 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
              {t('blog.home.testimonials.title', '客户评价')}
              </span>
              <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-secondary to-primary"></div>
            </h2>
            <p className="text-adaptive-muted max-w-2xl mx-auto">
              {t('blog.home.testimonials.description', 'Authentic reviews and feedback from our partners')}
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex flex-col items-center">
              <span className="badge badge-accent px-5 py-3 text-accent-content animate-pulse mb-4">{t('blog.home.contact.badge')}</span>
              <h2 className="text-4xl md:text-6xl font-bold mb-8 relative inline-block">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-secondary to-primary">
                {t('blog.home.contact.title')}
                </span>
                <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-secondary to-primary"></div>
              </h2>
            </div>
            <p className="text-xl text-adaptive-muted mb-10 max-w-2xl mx-auto">
              {t('blog.home.contact.description')}
            </p>
            <div className="inline-block">
              ...
              >
                {/* 按钮内部光效 */}
                <span className="absolute inset-0 w-full h-full bg-white/20 transform -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-in-out"></span>
                <span className="relative z-10">{t('blog.home.contact.buttonText')}</span>
